...
class PlacesRepositoryImpl implements PlacesRepository {
  ...
  PlacesRepositoryImpl({required PlacesRemoteDataSource placesRemoteDataSource, required LocalFavoriteDataSource localFavoriteDataSource})
      : _placesRemoteDataSource = placesRemoteDataSource, _favoriteDataSource = localFavoriteDataSource;
  ...
  Future<PlaceEntity> getPlaces() async {
    ...
    var entity = model.toEntity;
      entity.details?.forEach((detail) async {
        final isFav = await _favoriteDataSource.isFavorite(detail.monumHisComId!);
