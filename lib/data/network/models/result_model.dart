...
class ResultModel {
  ...
  @JsonKey(
      name: 'geo_point_2d', fromJson: _latLngFromJson, toJson: _latLngToJson)
  ...
  ResultEntity get toEntity => ResultEntity(
        ...
        copyrightEtPropriete: copyrightEtPropriete ?? "Aucune description",
        epoque: epoque,
        siecle: siecle,
        precisionSurLaProtection:
            precisionSurLaProtection ?? "Aucune description",
        dateDeProtection: dateDeProtection,
        classement: classement,
        statut: statut,
        description: description ?? "Aucune description",
        historique: historique ?? "Aucune description",
        auteur: auteur ?? "Aucune description",
        region: region ?? "Aucune description",
        departement: departement ?? "Aucune description",
        commune: commune ?? "Aucune description",
        niveauDeProtection: niveauDeProtection ?? "Aucune description",
        codeDepartement: codeDepartement ?? 1,
        insee: insee ?? 1,
